...
$ConfigurationFile = Get-ChildItem -Path $PWD -Recurse -Include "Uninstall-Microsoft365Apps.xml"
$Context.Log("Uninstalling Microsoft 365 Apps from: $($ConfigurationFile.FullName)")
$params = @{
