...
<#
    .SYNOPSIS
        Updates Adobe Acrobat Reader DC MUI x64 silently from packaged media.

    .DESCRIPTION
        This script locates the bundled Adobe Acrobat Reader DC MUI x64 update package (AcroRdrDCx64Upd*.msp)
    ...
    .EXAMPLE
        PS C:\> .\Install.ps1
        Updates Adobe Acrobat Reader DC MUI x64 from the current package source.
...
$Installer = Get-Installer -File "AcroRdrDCx64Upd*_MUI.msp"
